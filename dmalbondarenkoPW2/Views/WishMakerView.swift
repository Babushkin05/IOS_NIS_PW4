...
final class WishMakerView: UIView {
    ...
    private func configureActionStack() {
        ...
        actionStack.pinBottom(to: self, Constants.stackBottom)
        actionStack.pinHorizontal(to: self, Constants.stackLeading)
    }
    ...
    private func configureAddWishButton() {
        ...
        addWishButton.pinBottom(to: scheduleWishesButton.topAnchor, Constants.buttonBottom)
        addWishButton.pinHorizontal(to: self, Constants.stackLeading)
    }
    
    private func configureScheduleMissions(){
        scheduleWishesButton.backgroundColor = Constants.buttonBackgroundColor
        scheduleWishesButton.setTitleColor(Constants.buttonTitleColor, for: .normal)
        ...
        scheduleWishesButton.pinBottom(to: safeAreaLayoutGuide.bottomAnchor, Constants.buttonBottom)
        scheduleWishesButton.pinHorizontal(to: self, Constants.stackLeading)
    }
